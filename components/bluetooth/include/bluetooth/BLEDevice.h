...
#include "bluetooth/BLEScan.h"
#include "bluetooth/BLEServer.h"
#include "bluetooth/BLEUtils.h"
...
class BLEDevice {
   public:
    ...
    static std::string getValue(BLEAddress bdAddress,
                                BLEUUID serviceUUID,
                                BLEUUID characteristicUUID);                                                      // Get the value of a characteristic of a service on a server.
    ...
    static void setValue(BLEAddress bdAddress,
                         BLEUUID serviceUUID,
                         BLEUUID characteristicUUID,
                         std::string value);        // Set the value of a characteristic on a service on a server.
